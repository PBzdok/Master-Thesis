...
The communication between the two components will be realized through an \textbf{API}. The protocol used for such a communication will be standardized as described by \textcite{rfc2616}, which allows for systems
