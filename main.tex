...
\newcommand{\titelMAGerman}{Erklärbare künstliche Intelligenz:\\ Gestaltung von menschenzentrierten Benutzeroberflächen für KI-Bewertungssysteme zur Erhöhung von Erklärbarkeit und Vertrauenswürdigkeit von künstlicher Intelligenz in medizinischen Anwendungen}
...
The whole source code of the AI assessment system prototype can be found digitally in \nameref{appendix:usb_contents} or online on Gitlab (\url{https://gitlab.com/pbzdok/masters-thesis-code}). The following sections will reference parts of the source code when needed.
