...
% DEF FOR COVER %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\titelMA}{[Titel der Arbeit]}
\newcommand{\titelMAEnglish}{[Titel der Arbeit auf Englisch]}

\newcommand{\authorMA}{[Vorname Nachname des Studierenden]}

\newcommand{\examinerMA}{[Titel Vorname Nachname des Erstgutachters]}

\newcommand{\supporterMA}{[Titel Vorname Nachname des Betreuers]}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\chapter{Einleitung}
\begin{comment}
\textbf{Abholen:} Leser abholen und in das Thema einführen, d.h. breit beginnen und dann zuspitzen auf die konkrete Anwendung, um die es geht.

\textbf{Why should I care?:} Ihre Zeit ist teuer (Studium ist nicht kostenlos, meine auch nicht), warum investieren Sie Ihre (und meine) kostbare Zeit in dieses Thema? Die Frage "Why should I care?", d.h., die Relevanz des Themas, sollte im ersten Absatz schon positiv beantwortet sein. Im den Folgeabsätzen sollte der Leser zu dem Schluss kommen, dass Ihre Arbeit relevant und interessant ist (und nicht, weil Sie das behaupten, das ist ein Indiz dafür, dass man seine Zeit verschwendet). Wenn der Leser den Teil gelesen hat und Sie ihm sagen: "Und deswegen ist das wichtig." muss ein "No shit." zurückkommen, weil beim Lesen deutlichen geworden ist, warum das wichtig ist (zeigen, nicht sagen).

\textbf{Kein Copy-Paste aus dem Exposé:} Die Einleitung geht über das Exposé hinaus und einige Punkte aus dem Exposé sind hier auch irrelevant, z. B. der konkrete Zeitplan des Exposés. Nutzen Sie das Exposé als Grundlage, aber schreiben Sie einen neuen Text.
\end{comment}
...
\section{Realisierung der Systemarchitektur}
\begin{comment}
...
\section{Realisierung des Interfaces}
\begin{comment}
...
\section{Fazit zur Realisierung}
\begin{comment}
...
\subsection{Setting und Instrumente}
\begin{comment}
