...
The application is conceived for devices with relatively big screen sizes, such as desktop computers, laptops or tablets as there was no use case found for a mobile application (see \autoref{chapter:analysis}). As such the layout of the application will be vertically scrollable, optimized for landscape orientations to match the devices.
