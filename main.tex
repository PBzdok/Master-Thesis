...
\begin{table}[htbp]
    ...
    \begin{tabularx}{0.45\textwidth}{ l | c c c }
        ...
        \midrule
        \textit{N} & 14 & 14 & 14 \\
        \textit{mean} & 24.36 & 8.07 & 3.91 \\
        \textit{std} & 3.34 & 2.36 & 0.83 \\
        \textit{min} & 21 & 5 & 2.11 \\
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{ l | c c c c c c }
        ...
        \textit{mean} & 3.88 & 4.37 & 4.26 & 3.80 & 3.21 & 6.67 \\
        \textit{std} & 0.77 & 0.99 & 0.91 & 0.81 & 0.76 & 2.03 \\
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{ l | c c c c c c c }
        ...
        \midrule
        \textit{n} & 7 & 7 & 7 & 7 & 7 & 7 \\
        \textit{mean} & 3.67 & 3.94 & 3.82 & 3.44 & 2.73 & 6.34 \\
        \textit{std} & 1.01 & 1.19 & 1.06 & 0.94 & 0.70 & 1.94 \\
        \textit{min} & 2.00 & 1.40 & 1.67 & 1.80 & 1.38 & 4.00 \\
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{ l | c c c c c c c }
        ...
        \midrule
        \textit{n} & 7 & 7 & 7 & 7 & 7 & 7 \\
        \textit{mean} & 4.10 & 4.80 & 4.71 & 4.17 & 3.70 & 7.00 \\
        \textit{std} & 0.41 & 0.54 & 0.45 & 0.47 & 0.48 & 2.21 \\
...
\begin{table}[htbp]
    \centering
    \begin{tabularx}{0.75\textwidth}{ l l | c c c }
        \toprule
        & & SIPA (pre) & FOST (pre) & ATI \\
        \midrule
        \multirow{2}{*}{SIPA (pre)} & Pearson's r & --- & & \\
        & p-value & --- & & \\
        \multirow{2}{*}{FOST (pre)} & Pearson's r & .567* & --- & \\
        & p-value & .034 & --- & \\
        \multirow{2}{*}{ATI} & Pearson's r & .131 & -.040 & --- \\
        & p-value & .656 & .891 & --- \\
        \bottomrule
        \multicolumn{5}{l}{\footnotesize * p < .05, ** p < .01, *** p < .001} \\
    \end{tabularx}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{ l l | c c c c c }
        ...
        \midrule
        \multirow{2}{*}{ATI} & Pearson's r & --- & & & & \\
        & p-value & --- & & & & \\
        \multirow{2}{*}{SIPA (post)} & Pearson's r & .098 & --- & & & \\
        & p-value & .739 & --- & & & \\
        \multirow{2}{*}{FOST (post)} & Pearson's r & -.023 & .776** & --- & & \\
        & p-value & .938 & .001& --- & & \\
        \multirow{2}{*}{ESS} & Pearson's r & -.034 & .705** & .680** & --- & \\
        & p-value & .909 & .005 & .007 & --- & \\
        \multirow{2}{*}{NASA-TLX} & Pearson's r & .496 & -.343 & -.381 & -.293 & --- \\
        & p-value & .071 & .229 & .179 & .310 & --- \\
        \bottomrule
