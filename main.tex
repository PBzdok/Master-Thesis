...
\newpage
\chapter{Conclusion}
With the all pervasive use of artificial intelligence in current technological advances, the XAI research domain grows ever since. Although explaining AI can be done in many ways, a human-centered and interactive version was developed to facilitate understandability and trust in such intelligent systems. Leveraging the knowledge of the HCI domain and combining it with current XAI literature, tools and research partners has resulted in conceptualizing, implementing and evaluating an interactive AI assessment interface for the context of medical applications. Considering the potential user's needs and requirements throughout the entire development process is an important part of application development.\todo{describe evaluation results} Therefore a strong focus on the human aspects yielded evaluation results, which depict clear connections between interactive explanations, explainability and trustworthiness of AI models. However, the concepts of explainability and trustworthiness are very complex and cannot be captured in their entirety by such a study - but reviewing the results of the thesis gives insights on HCI in the context of XAI and invites to further research.
