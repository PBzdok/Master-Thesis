...
\begin{table}[htbp]
    ...
    \begin{tabularx}{0.65\textwidth}{ l l c c c }
        ...
        \midrule
        \multirow{2}{*}{SIPA (pre)} & \textit{r} & --- & & \\
        & \textit{p} & --- & & \\
        \multirow{2}{*}{FOST (pre)} & \textit{r} & .567* & --- & \\
        & \textit{p} & .034 & --- & \\
        \multirow{2}{*}{ATI} & \textit{r} & .131 & -.040 & --- \\
        & \textit{p} & .656 & .891 & --- \\
        \bottomrule
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{0.9\textwidth}{ l l c c c c c }
        ...
        \midrule
        \multirow{2}{*}{ATI} & \textit{r} & --- & & & & \\
        & \textit{p} & --- & & & & \\
        \multirow{2}{*}{SIPA (post)} & \textit{r} & .098 & --- & & & \\
        & \textit{p} & .739 & --- & & & \\
        \multirow{2}{*}{FOST (post)} & \textit{r} & -.023 & .776** & --- & & \\
        & \textit{p} & .938 & .001& --- & & \\
        \multirow{2}{*}{ESS} & \textit{r} & -.034 & .705** & .680** & --- & \\
        & \textit{p} & .909 & .005 & .007 & --- & \\
        \multirow{2}{*}{NASA-TLX} & \textit{r} & .496 & -.343 & -.381 & -.293 & --- \\
        & \textit{p} & .071 & .229 & .179 & .310 & --- \\
        \bottomrule
